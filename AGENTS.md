...
- Only the user-triggered recent WAV clip may be relayed to Doubao; only its transcript may be sent to DeepSeek.
...
- Keep public documentation concise and avoid parallel plans, reports, or status documents.
